...
관련 자산: `skill-creator`(스킬 sibling — 같은 6 phase 구조), `hook-creator`(훅 sibling), `agent-skill-designer`(타입·책임 결정), `agent-skill-auditor`(정적 rule 감사).
