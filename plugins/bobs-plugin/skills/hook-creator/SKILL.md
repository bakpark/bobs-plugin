...
관련 자산: `skill-creator`(반복 가능한 판단 절차), `agent-creator`(서브에이전트), `agent-skill-designer`(타입·책임 결정), `agent-skill-auditor`(정적 rule 감사).
